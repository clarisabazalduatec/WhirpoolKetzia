            ...
            {notificaciones.length === 0 ? (
              ...
              notificaciones.map((n) => (
                <button
                  ...
                  className={`w-full p-4 border-b border-slate-50 flex gap-3 items-start text-left hover:bg-slate-50 transition-colors ${!n.leida ? 'bg-blue-50/50' : ''}`}
                >
                  {/* Icono */}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-slate-400 font-bold mt-1">{formatFecha(n.fecha)}</p>
                  </div>
